...
type TopReq struct {
	...
	// 个数
	// @gotags: default:"5" validate:"min=1,max=10"
	Size int32 `protobuf:"varint,3,opt,name=size,proto3" json:"size,omitempty" default:"5" validate:"min=1,max=10"`
	// 类型
	// @gotags: default:"1" validate:"oneof=1"
	Type kernel.RecommendType `protobuf:"varint,4,opt,name=type,proto3,enum=com.itcoursee.core.kernel.RecommendType" json:"type,omitempty" default:"1" validate:"oneof=1"`
	// 字段筛选

...
type AddReq struct {
	...
	Type Type `protobuf:"varint,4,opt,name=type,proto3,enum=com.itcoursee.core.course.Type" json:"type,omitempty"`
	// 标签列表
	// 最大十个标签
...
var file_com_itcoursee_core_course_add_proto_rawDesc = []byte{
	...
	0x6c, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_com_itcoursee_core_course_add_proto_goTypes = []interface{}{
	...
	(Type)(0),            // 2: com.itcoursee.core.course.Type
...
var file_com_itcoursee_core_course_add_proto_depIdxs = []int32{
	2, // 0: com.itcoursee.core.course.AddReq.type:type_name -> com.itcoursee.core.course.Type
...
func file_com_itcoursee_core_course_add_proto_init() {
	...
	file_com_itcoursee_core_course_type_proto_init()
	if !protoimpl.UnsafeEnabled {

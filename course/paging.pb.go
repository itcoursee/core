...
type PagingReq struct {
	...
	// 分类，可以使用前缀来表示分类状态（+表示包含所有子分类，-表示包含一级分类）
	Category string `protobuf:"bytes,6,opt,name=category,proto3" json:"category,omitempty"`
	// 排序
	Order string `protobuf:"bytes,13,opt,name=order,proto3" json:"order,omitempty"`
	// 排序字段
	// @gotags: default:"id"
	Sort string `protobuf:"bytes,14,opt,name=sort,proto3" json:"sort,omitempty" default:"id"`
	// 字段筛选
	// @gotags: validate:"dive,oneof=tags category direction covers"
	Fields []string `protobuf:"bytes,15,rep,name=fields,proto3" json:"fields,omitempty" validate:"dive,oneof=tags category direction covers"`
}
...
func (x *PagingReq) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
var file_com_itcoursee_core_course_paging_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01, 0x0a, 0x09, 0x50, 0x61, 0x67, 0x69,
	...
	,
	...
	0x73, 0x42, 0x46, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x74, 0x63, 0x6f, 0x75, 0x72, 0x73,
	0x65, 0x65, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x50, 0x01,
